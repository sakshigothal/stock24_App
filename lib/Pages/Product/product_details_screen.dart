...
class ProductDetailsScreen extends StatefulWidget {
  final check;
  const ProductDetailsScreen({Key? key, this.check}) : super(key: key);
        ...
        child: Column(
          children: [
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: ()async{
                            ...
                            final uri=Uri.parse(product_images[0].image.toString());
                            final res=await http.get(uri);
                            final bytes=res.bodyBytes;
                            final temp=await getTemporaryDirectory();
                            final path='${temp.path}/image.jpg';
                            File(path).writeAsBytesSync(bytes);
                            Share.shareFiles([path],text: 'product Name: $productName\nSize:$size\nBody:$body\nFinish:$finish\nTiles per box:$tiles_per_box\nSqmrt Per box:$sqmtr_per_box\n Sqft per box:$sqft_per_box\nPrice:$price\nMRP:$mrp\nStatus:Running ');
                          // Share.share('shcbsjyugdiku');
                          // Share.shareFiles(['http://skyonliners.com/demo/stock24/storage/app/public/uploads/products/products_10_1.jpg,'],subject: 'bgfh',text: 'bc cfg',mimeTypes: ['http://skyonliners.com/demo/stock24/storage/app/public/uploads/products/products_10_1.jpg,']);
                        },
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 46, right: 13),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 120, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
                  customText(size, 16, primaryColor,
                      'Roboto-Regular')
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 114, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 106, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
                  customText(finish, 16, primaryColor, 'Roboto-Regular')
                ],
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 58, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 48, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 61, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
                ...
                ? Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 93, right: 13),
                          child: customText(
            ...
            widget.check == true
                ? Padding(
                    ...
                    child: Row(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left: 148, right: 13),
                          child: customText(
                              ':', 16, primaryColor, 'Roboto-Regular'),
                        ),
                        customText(
            ...
            ListView.builder(
              shrinkWrap: true,
              itemBuilder: (ctx,index){
              return customText('${batch[index].batchCode}: ${batch[index].batchId} ', 16, primaryColor, 'Roboto-Regular');
            },itemCount: batches.length,) : SizedBox(),
            Padding(
              padding: const EdgeInsets.only(bottom: 15, left: 20, right: 20),
              child: Row(
                children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 108, right: 13),
                    child: customText(':', 16, primaryColor, 'Roboto-Regular'),
                  ),
            ...
            widget.check == false
                ? Padding(
                    padding: const EdgeInsets.only(bottom: 25, top: 59),
                    child: Center(
                      child: GetStorage().read('role') == 'dealer' ? SizedBox() : InkWell(
                        onTap: () {
                          // openAlert();
                          productController.addToWishListProduct(context, product_id);
                          print('product_id----> $product_id');
                        },
                        child: Container(
                          height: 55,
                          width: getWidth(context) * 0.46,
